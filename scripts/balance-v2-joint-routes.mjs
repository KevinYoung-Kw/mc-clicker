// P7: include useful first purchases outside route wish-lists; skip capped personal skills.
...
export function simulate(route, { afterIncome = null, seed = 17, limit = maxSeconds, stopAtNether = false } = {}) {
  ...
  return {
    provenance:{engine:engineName,engineSha256:sourceHashes.sha256,policy:lifePolicy?'P7-life-policy':'P7-open-investments',policySha256:createHash('sha256').update(readFileSync(new URL(import.meta.url))).digest('hex'),seed,stopAtNether},
    foodCare,
    electricity,
